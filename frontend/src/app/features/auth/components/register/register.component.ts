    ...
    <div class="auth-page">
      <div class="auth-branding">
        <div class="branding-content">
          ...
          <h1>Devis BTP</h1>
          <p class="branding-tagline">{{ 'AUTH.TAGLINE_REGISTER' | translate }}</p>
          <div class="branding-features">
            <div class="feature-item">
              <mat-icon>speed</mat-icon>
              <span>{{ 'AUTH.FEATURE_SPEED' | translate }}</span>
            </div>
            <div class="feature-item">
              <mat-icon>palette</mat-icon>
              <span>{{ 'AUTH.FEATURE_CUSTOM' | translate }}</span>
            </div>
            <div class="feature-item">
              <mat-icon>cloud_done</mat-icon>
              <span>{{ 'AUTH.FEATURE_CLOUD' | translate }}</span>
            </div>
          </div>
        </div>
      ...
      <div class="auth-form-side">
        <div class="auth-card">
          ...
          <div class="auth-footer">
            ...
            <a routerLink="/auth/login">{{ 'AUTH.LOGIN_LINK' | translate }}</a>
          </div>
        </div>
      </div>
    </div>
...
export class RegisterComponent {
  ...
  onSubmit() {
    if (this.form.valid) {
      ...
      this.authStore.register(email, password, fullName);
    }
  }
}
